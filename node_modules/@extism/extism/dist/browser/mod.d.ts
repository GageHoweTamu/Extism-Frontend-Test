import { type ExtismPluginOptions, type ManifestLike, type Plugin } from './interfaces';
export { CAPABILITIES } from './polyfills/deno-capabilities';
export type { Capabilities, ExtismPluginOptions, LogLevel, Manifest, ManifestLike, ManifestWasm, ManifestWasmData, ManifestWasmModule, ManifestWasmPath, ManifestWasmResponse, ManifestWasmUrl, MemoryOptions, Plugin, PluginConfig, PluginConfigLike, PluginOutput, } from './interfaces';
export type { CallContext, CallContext as CurrentPlugin } from './call-context';
/**
