...
export interface NativeManifestOptions extends Pick<ExtismPluginOptions, 'allowedPaths' | 'allowedHosts' | 'memory' | 'config' | 'timeoutMs'> {
}
/**
...
export declare const SAB_BASE_OFFSET = 4;
export declare enum SharedArrayBufferSection {
    End = 255,
    RetI64 = 1,
    RetF64 = 2,
    RetVoid = 3,
...
export declare function logLevelToPriority(level: LogLevel): LogLevelPriority;
export type LogLevelPriority = 0 | 1 | 2 | 3 | 4 | 0x7fffffff;
export declare function priorityToLogLevel(level: LogLevelPriority): LogLevel;
export {};
