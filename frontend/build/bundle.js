(() => {
  ...
  var ls = (l, t, e) => (e = l != null ? $e(es(l)) : {}, ns(t || !l || !l.__esModule ? zt(e, "default", { value: l, enumerable: true }) : e, l));
  var le = (l, t, e) => (is(l, typeof t != "symbol" ? t + "" : t, e), e);
  var Ft = (l, t, e) => {
    if (!t.has(l)) throw TypeError("Cannot " + e);
  };
  var p = (l, t, e) => (Ft(l, t, "read from private field"), e ? e.call(l) : t.get(l));
  var L = (l, t, e) => {
    if (t.has(l)) throw TypeError("Cannot add the same private member more than once");
    t instanceof WeakSet ? t.add(l) : t.set(l, e);
  };
  var W = (l, t, e, s) => (Ft(l, t, "write to private field"), s ? s.call(l, e) : t.set(l, e), e);
  var v = (l, t, e) => (Ft(l, t, "access private method"), e);
  var Re = ne((fn, Ie) => {
    "use strict";
    Ie.exports = Xe;
    function Xe(l, t, e) {
  ...
  var we = ne((In, Ke) => {
    var We = Re();
    Ke.exports = Gs;
    var ge = "\0SLASH" + Math.random() + "\0", xe = "\0OPEN" + Math.random() + "\0", vt = "\0CLOSE" + Math.random() + "\0", Ve = "\0COMMA" + Math.random() + "\0", Le = "\0PERIOD" + Math.random() + "\0";
    function Ut(l) {
      return parseInt(l, 10) == l ? parseInt(l, 10) : l.charCodeAt(0);
    }
    function Zs(l) {
      return l.split("\\\\").join(ge).split("\\{").join(xe).split("\\}").join(vt).split("\\,").join(Ve).split("\\.").join(Le);
    }
    function ys(l) {
      return l.split(ge).join("\\").split(xe).join("{").split(vt).join("}").split(Ve).join(",").split(Le).join(".");
    }
    function Se(l) {
      if (!l) return [""];
      var t = [], e = We("{", "}", l);
    ...
    function yt(l, t) {
      ...
      if (/\$$/.test(s.pre)) for (var n = 0; n < i.length; n++) {
        ...
        var b;
        if (d) {
          var y = Ut(u[0]), m = Ut(u[1]), Z = Math.max(u[0].length, u[1].length), G = u.length == 3 ? Math.abs(Ut(u[2])) : 1, V = Is, g = m < y;
          g && (G *= -1, V = Rs);
          var T = u.some(fs);
          b = [];
          for (var J = y; V(J, m); J += G) {
            var w;
            if (a) w = String.fromCharCode(J), w === "\\" && (w = "");
            else if (w = String(J), T) {
              var N = Z - w.length;
              if (N > 0) {
                var ht = new Array(N + 1).join("0");
                J < 0 ? w = "-" + ht + w.slice(1) : w = ht + w;
              }
            }
            b.push(w);
          }
  ...
  var oe = globalThis.WebAssembly || {};
  var M = { supportsJSPromiseInterface: typeof oe.Suspending == "function" && typeof oe.promising == "function", allowSharedBufferCodec: false, manifestSupportsPaths: false, crossOriginChecksEnforced: true, fsAccess: false, hasWorkerCapability: typeof globalThis < "u" ? globalThis.crossOriginIsolated && typeof SharedArrayBuffer < "u" : true, supportsWasiPreview1: true, supportsTimeouts: true, extismStdoutEnvVarSet: false };
  var Wt;
  var mt;
  var Jt = class extends DataView {
    constructor(e) {
      super(e);
      L(this, mt, null);
    }
    ...
    string() {
      return p(Jt, Wt).decode(this.buffer);
    }
    bytes() {
  ...
  var gt = Symbol("end");
  var k = Symbol("env");
  var bt = Symbol("set-host-context");
  var pt = Symbol("get-block");
  var xt = Symbol("import-state");
  var Vt = Symbol("export-state");
  var A = Symbol("store-value");
  var it = Symbol("reset");
  var f = class {
    get byteLength() {
  ...
  var ct = class {
    ...
    read(t) {
      ...
      if (!s) return null;
      let o = !(s.buffer instanceof ArrayBuffer) && !M.allowSharedBufferCodec ? new Uint8Array(s.buffer).slice().buffer : s.buffer;
      return new B(o);
    }
    store(t) {
      let e = this[A](t);
  ...
  var _t = class {
    ...
    constructor(t, e, s, o = {}) {
      ...
      this.wasiImport = { args_sizes_get(n, r) {
        ...
        if (i.fds[n] != null) {
          let b = j.read_bytes_array(h, r, c), { ret: y, nread: m } = i.fds[n].fd_pread(u, b, a);
        ...
        let h = new DataView(i.inst.exports.memory.buffer), u = new Uint8Array(i.inst.exports.memory.buffer);
        if (i.fds[n] != null) {
          let b = D.read_bytes_array(h, r, c), { ret: y, nwritten: m } = i.fds[n].fd_pwrite(u, b, a);
          return h.setUint32(d, m, true), y;
        } else return 8;
      }, fd_read(n, r, c, a) {
        let d = new DataView(i.inst.exports.memory.buffer), h = new Uint8Array(i.inst.exports.memory.buffer);
        if (i.fds[n] != null) {
          let u = j.read_bytes_array(d, r, c), { ret: b, nread: y } = i.fds[n].fd_read(h, u);
        ...
        let d = new DataView(i.inst.exports.memory.buffer), h = new Uint8Array(i.inst.exports.memory.buffer);
        if (i.fds[n] != null) {
          let u = D.read_bytes_array(d, r, c), { ret: b, nwritten: y } = i.fds[n].fd_write(h, u);
          return d.setUint32(a, y, true), b;
        } else return 8;
        ...
        if (i.fds[n] != null) {
          ...
          P.log(G);
          let { ret: V, fd_obj: g } = i.fds[n].path_open(r, G, d, h, u, b);
          if (V != 0) return V;
          i.fds.push(g);
  ...
  var Xt = (l) => l.replace(/[[\]\\-]/g, "\\$&");
  var gs = (l) => l.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&");
  var Ce = (l) => l.join("");
  var Te = (l, t) => {
    let e = t;
    ...
    t: for (; i < l.length; ) {
      ...
      if (m === "[" && !c) {
        for (let [Z, [G, V, g]] of Object.entries(Ws)) if (l.startsWith(Z, i)) {
          if (h) return ["$.", false, l.length - e, true];
          i += Z.length, g ? o.push(G) : s.push(G), r = r || V;
          continue t;
        }
      }
      if (c = false, h) {
  ...
  var H = class {
    constructor(t, e, s = {}) {
      ...
      L(this, rt, void 0);
      L(this, ft, false);
      this.type = t, t && W(this, K, true), W(this, x, e), W(this, S, p(this, x) ? p(p(this, x), S) : this), W(this, U, p(this, S) === this ? s : p(p(this, S), U)), W(this, ot, p(this, S) === this ? [] : p(p(this, S), ot)), t === "!" && !p(p(this, S), et) && p(this, ot).push(this), W(this, tt, p(this, x) ? p(p(this, x), R).length : 0);
    }
    get hasMagic() {
    ...
    push(...t) {
      for (let e of t) if (e !== "") {
        if (typeof e != "string" && !(e instanceof H && p(e, x) === this)) throw new Error("invalid part: " + e);
        p(this, R).push(e);
      }
    }
    toJSON() {
      let t = this.type === null ? p(this, R).slice().map((e) => typeof e == "string" ? e : e.toJSON()) : [this.type, ...p(this, R).map((e) => e.toJSON())];
      return this.isStart() && !this.type && t.unshift([]), this.isEnd() && (this === p(this, S) || p(p(this, S), et) && p(this, x)?.type === "!") && t.push({}), t;
    }
    isStart() {
      if (p(this, S) === this) return true;
      if (!p(this, x)?.isStart()) return false;
    ...
    isEnd() {
      if (p(this, S) === this || p(this, x)?.type === "!") return true;
      if (!p(this, x)?.isEnd()) return false;
      if (!this.type) return p(this, x)?.isEnd();
      let t = p(this, x) ? p(p(this, x), R).length : 0;
    ...
    toRegExpSource(t) {
      ...
      if (p(this, S) === this && v(this, Ht, ze).call(this), !this.type) {
        let c = this.isStart() && this.isEnd(), a = p(this, R).map((b) => {
          var V;
          let [y, m, Z, G] = typeof b == "string" ? v(V = H, Nt, Fe).call(V, b, p(this, K), c) : b.toRegExpSource(t);
        ...
        let h = "";
        return this.isEnd() && p(p(this, S), et) && p(this, x)?.type === "!" && (h = "(?:$|\\/)"), [d + a + h, q(a), W(this, K, !!p(this, K)), p(this, _)];
      }
  ...
  var st = H;
  S = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), tt = /* @__PURE__ */ new WeakMap(), ot = /* @__PURE__ */ new WeakMap(), et = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), rt = /* @__PURE__ */ new WeakMap(), ft = /* @__PURE__ */ new WeakMap(), Ht = /* @__PURE__ */ new WeakSet(), ze = function() {
  ...
  }, Nt = /* @__PURE__ */ new WeakSet(), Fe = function(t, e, s = false) {
  ...
  var jt = (l, { windowsPathsNoEscape: t = false } = {}) => t ? l.replace(/[?*()[\]]/g, "[$&]") : l.replace(/[?*()[\]\\]/g, "\\$&");
  var C = (l, t, e = {}) => (Gt(t), !e.nocomment && t.charAt(0) === "#" ? false : new dt(t, e).match(l));
  var Cs = /^\*+([^+@!?\*\[\(]*)$/;
  var Ts = (l) => (t) => !t.startsWith(".") && t.endsWith(l);
  var Hs = (l) => (t) => t.endsWith(l);
  var Ns = (l) => (l = l.toLowerCase(), (t) => !t.startsWith(".") && t.toLowerCase().endsWith(l));
  var Ys = (l) => (l = l.toLowerCase(), (t) => t.toLowerCase().endsWith(l));
  var zs = /^\*+\.\*+$/;
  var Fs = (l) => !l.startsWith(".") && l.includes(".");
  var Js = (l) => l !== "." && l !== ".." && l.includes(".");
  var ks = /^\.\*+$/;
  var Ps = (l) => l !== "." && l !== ".." && l.startsWith(".");
  var Es = /^\*+$/;
  var Ms = (l) => l.length !== 0 && !l.startsWith(".");
  var Bs = (l) => l.length !== 0 && l !== "." && l !== "..";
  var Os = /^\?+([^+@!?\*\[\(]*)?$/;
  var _s = ([l, t = ""]) => {
    let e = Ee([l]);
  ...
  var Be = typeof process == "object" && process ? typeof process.env == "object" && process.env && process.env.__MINIMATCH_TESTING_PLATFORM__ || process.platform : "posix";
  var Je = { win32: { sep: "\\" }, posix: { sep: "/" } };
  var As = Be === "win32" ? Je.win32.sep : Je.posix.sep;
  C.sep = As;
  ...
  var $s = "(?:(?!(?:\\/|^)(?:\\.{1,2})($|\\/)).)*?";
  var qs = "(?:(?!(?:\\/|^)\\.).)*?";
  var ti = (l, t = {}) => (e) => C(e, l, t);
  C.filter = ti;
  var Y = (l, t = {}) => Object.assign({}, l, t);
  var ei = (l) => {
  ...
  var dt = class {
    ...
    matchOne(t, e, s = false) {
      let o = this.options;
      if (this.isWindows) {
        let m = typeof t[0] == "string" && /^[a-z]:$/i.test(t[0]), Z = !m && t[0] === "" && t[1] === "" && t[2] === "?" && /^[a-z]:$/i.test(t[3]), G = typeof e[0] == "string" && /^[a-z]:$/i.test(e[0]), V = !G && e[0] === "" && e[1] === "" && e[2] === "?" && typeof e[3] == "string" && /^[a-z]:$/i.test(e[3]), g = Z ? 3 : m ? 0 : void 0, T = V ? 3 : G ? 0 : void 0;
        if (typeof g == "number" && typeof T == "number") {
          let [J, w] = [t[g], e[T]];
          J.toLowerCase() === w.toLowerCase() && (e[T] = J, T > g ? e = e.slice(T) : g > T && (t = t.slice(g)));
        }
      }
...
>>> no match, partial?`, t, u, e, b), u === c));
    ...
    parse(t) {
      ...
      if (t === "") return "";
      let s, o = null;
      (s = t.match(Es)) ? o = e.dot ? Bs : Ms : (s = t.match(Cs)) ? o = (e.nocase ? e.dot ? Ys : Ns : e.dot ? Hs : Ts)(s[1]) : (s = t.match(Os)) ? o = (e.nocase ? e.dot ? Us : _s : e.dot ? vs : Qs)(s) : (s = t.match(zs)) ? o = e.dot ? Js : Fs : (s = t.match(ks)) && (o = Ps);
    ...
    makeRe() {
      ...
      let e = this.options, s = e.noglobstar ? Ds : e.dot ? $s : qs, o = new Set(e.nocase ? ["i"] : []), i = t.map((c) => {
        let a = c.map((d) => {
  ...
  var ut = class {
    ...
    contribute(t) {
      t[F] ??= {}, t[F].http_request = (e, s, o) => this.makeRequest(e, s, o), t[F].http_status_code = () => this.lastStatusCode, t[F].http_headers = (e) => this.lastHeaders === null ? 0n : e.store(JSON.stringify(this.lastHeaders));
    }
    async makeRequest(t, e, s) {
      this.lastHeaders !== null && (this.lastHeaders = {}), this.lastStatusCode = 0;
      let o = t.read(e);
      if (o === null) return 0n;
      let { headers: i, header: n, url: r, method: c } = o.json(), a = c ?? "GET", d = new URL(r);
  ...
  var F = "extism:host/env";
  var oi = (async () => {
  }).constructor;
  var Dt = WebAssembly.Suspending;
  var te = WebAssembly.promising;
  var $t = class {
    #t;
    #e;
    #s = false;
    ...
    async callBlock(t, e) {
      ...
      this.#t[Et](e ?? null);
      try {
        return this.#l ? await te(s)() : s(), this.#t[gt]();
      } catch (o) {
        throw this.#t[gt](), o;
      } finally {
        this.#s = false;
  ...
  async function Ue(l, t, e, s = new ct(ArrayBuffer, l.logger, l.logLevel, l.config, l.memory)) {
    ...
    if (i && (!Dt || !te)) throw new TypeError("This platform does not support async function imports on the main thread; consider using `runInWorker`.");
    ...
    for (let { kind: m, module: Z, name: G } of h) {
      ...
      if (V === -1) {
        if (Z === "wasi_snapshot_preview1" && u === null) {
          if (!M.supportsWasiPreview1) throw new Error("WASI is not supported on this platform");
        ...
        if (Z === F && G === "http_request" && te && s[Z][G] === l[k].http_request) {
          let g = new ut(o.fetch, o.allowedHosts, o.memory, o.allowHttpResponseHeaders);
          a.suspendsOnInvoke = true;
          let T = {};
          g.contribute(T);
          for (let [J, w] of Object.entries(T[F])) s[Z][J] = w.bind(null, l);
          s[Z][G] = new Dt(s[Z][G]);
        }
        switch (m) {
          case "function": {
        ...
        let g = r[V], T = WebAssembly.Module.exports(g);
        if (!T.find((N) => N.name === G && N.kind === m)) throw new Error(`from module "${t.join('"/"')}": cannot import "${Z}" "${G}"; no export matched request`);
        let w = T.find((N) => N.name === "_start") ? await qt(l, [...t, Z], g, s, o, i, n, r, /* @__PURE__ */ new Map(), a) : (c.has(g) || await qt(l, [...t, Z], g, s, o, i, n, r, c, a), c.get(g));
  ...
  var ve = new URL("data:text/javascript;base64,");
  var Qe = /* @__PURE__ */ new WeakMap();
  var Rt = class extends (globalThis.Worker || Object) {
    constructor(t) {
  ...
  var ee = class {
    ...
    async #s() {
      ...
      let e = {}, s = {}, o = await Promise.race([se(this.opts.timeoutMs, e), Promise.all([ie(this.worker), je(this.opts, this.names, this.modules, this.sharedData)])].filter(Boolean)).catch(() => s);
      if (this.#t[it](), o === e) {
    ...
    async call(t, e, s) {
      ...
      let d = new B(M.allowSharedBufferCodec ? a.buffer : new Uint8Array(a.buffer).slice().buffer);
      if (r) {
    ...
    async #a(t) {
      ...
      try {
        ...
        new Uint8Array(this.sharedData).subarray(8).fill(254), this.#t[xt](t.state, true);
  ...
  async function Ae(l, t, e) {
    ...
    new ut(l.fetch, l.allowedHosts, l.memory, l.allowHttpResponseHeaders).contribute(l.functions), l.functions[F] ??= {}, l.functions[F].var_get ??= (d, h) => s[k].var_get(h), l.functions[F].var_set ??= (d, h, u) => s[k].var_set(h, u);
    let i = new SharedArrayBuffer(l.sharedArrayBufferSize);
    new Uint8Array(i).subarray(8).fill(254);
    let n = {}, r, c = (d) => {
      r = d;
    }, a = await Promise.race([se(l.timeoutMs, n), je(l, t, e, i, c)].filter(Boolean));
    if (a === n) throw await ie(r), new Error("EXTISM: timed out while waiting for plugin to instantiate");
    return new ee(a, i, t, e, l, s);
  }
  async function je(l, t, e, s, o = (i) => {
  }) {
